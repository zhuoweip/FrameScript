...
// the contents of the screen. This is the mobile version
// which doesn't use a grabpass and requires the screen
// contents to be given as texture.
//

Shader "Scene Manager/Back Buffer Copy Mobile" {
   Properties {
