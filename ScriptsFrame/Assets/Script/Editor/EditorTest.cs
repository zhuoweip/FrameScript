//https://blog.csdn.net/AGroupOfRuffian/article/details/79170872
...
public class EditorTest : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        gameObject = (GameObject) EditorGUILayout.ObjectField("任意类型 举例GameObject:", gameObject,typeof(GameObject), false);
    ...
    void SecondWindow(int unusedWindowID)
    {
        ...
        gameObject = (GameObject)EditorGUILayout.ObjectField("当前选中的物体：", Selection.activeGameObject, typeof(GameObject), false);
        ...
        hitGo = (GameObject)EditorGUILayout.ObjectField("鼠标发送射线：", hitGo != null ? hitGo : null, typeof(GameObject), false);
    ...
    void SecondWindow2(int unusedWindowID)
    {
        ...
        Handles.CircleCap(1, new Vector2(300, 150), Quaternion.identity, capSize);//用最新的方法显示不了不知道为什么

        Handles.color = Color.green;
        Handles.SphereCap(2, new Vector2(100, 250), Quaternion.Euler(capEuler), capSize);
        Handles.CircleCap(3, new Vector2(300, 250), Quaternion.Euler(capEuler), capSize);
