...
namespace Jacovone
{
	...
	/// </summary>
		...
		/// <summary>
		/// The waypoints that defines the path.
		/// </summary>
		...
		/// <summary>
		/// The target that will follow the path.
		/// </summary>
		...
		/// <summary>
		/// If the global look at is set, the target will look at that each frame.
		/// </summary>
		...
		/// <summary>
		/// If enabled, the target will follow the path in direction.
		/// </summary>
		...
		/// <summary>
		/// The last passed wayponint, for event management.
		/// </summary>
